...
__sthread_lock:
        ...
        movl      $1, %eax              # First, we move 1 into eax.         
        lock xchg %eax, scheduler_lock  # We then exchange the value in eax
                                          # with the value in scheduler_lock.
                                        # This is locked, so nothing could
                                          # disturb the process.
        xorl      $1, %eax              # This gets the opposite of what was
                                          # in eax (which is the old value of
                                          # scheduler_lock)
        ret
...
__sthread_unlock:
        ...
        movl     $0, scheduler_lock     # This moves 0 into the scheduler_lock
        ret
...
__sthread_restore:
        ...
        call    __sthread_unlock        # We lock every time we call scheduler.
                                          # Thus, we have to unlock at the
                                          # end of scheduler.
        ret
